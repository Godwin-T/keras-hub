...
from keras_hub.src.models.modernbert.modernbert_attention import (
    ModernbertAttention,
)
from keras_hub.src.utils.keras_utils import clone_initializer


class ModernbertTransformerEncoder(keras.layers.Layer):
    """A Transformer encoder layer for the Modernbert backbone."""
    ...
    def build(self, decoder_sequence_shape):
        ...
        self._self_attention_layer = ModernbertAttention(
    ...
    def call(
        ...
        x = self._feedforward_output_dense(x)  # ops.multiply(x, gate_output)
