...
def modernbert_kernel_initializer(stddev=0.02):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.token_embedding = ReversibleEmbedding(
            ...
            embeddings_initializer=modernbert_kernel_initializer(),
            dtype=dtype,
        ...
        for i in range(num_layers):
            layer = TransformerEncoder(
                ...
                kernel_initializer=modernbert_kernel_initializer(),
                dtype=dtype,
        ...
        positions = self.rotary_embedding(tokens, start_index=0)
