...
from keras_hub.src.models.modernbert.modernbert_encoder import (
    ModernbertTransformerEncoder,
)
...
@keras_hub_export("keras_hub.models.ModelBertBackbone")
    ...
    def __init__(
        ...
        **kwargs,
        ...
        for i in range(num_layers):
            layer = ModernbertTransformerEncoder(
