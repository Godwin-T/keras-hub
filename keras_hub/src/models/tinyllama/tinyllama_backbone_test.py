...
class TinyllamaTest(TestCase):
    ...
    def test_num_parameters(self):
        model = TinyllamaBackbone(**self.init_kwargs)
    ...
    def test_all_presets(self):
        for preset in TinyllamaBackbone.presets:
            self.run_preset_test(
                cls=TinyllamaBackbone,
                preset=preset,
                input_data=self.input_data,
    ...
    def test_distribution(self):
        ...
        layout_map = TinyllamaBackbone.get_layout_map(device_mesh)
