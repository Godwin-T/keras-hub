...
from keras_hub.src.models.tinyllama.tinyllama_attention import (
    TinyllamaAttention,
)
...
class TinyllamaTransformerDecoder(keras.layers.Layer):
    """A Transformer decoder layer for the Tinyllama backbone."""
    ...
    def build(self, decoder_sequence_shape):
        ...
        self._self_attention_layer = TinyllamaAttention(
        ...
        self._self_attention_layernorm = TinyllamaLayerNorm(
        ...
        self._feedforward_layernorm = TinyllamaLayerNorm(
            epsilon=self.layer_norm_epsilon,
            dtype=self.dtype_policy,
